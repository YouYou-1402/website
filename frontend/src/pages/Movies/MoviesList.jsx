...
const MoviesList = () => {
  ...
  const { data: genresData } = useApi(API_ENDPOINTS.MOVIES.GENRES);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-vintage-sepia max-w-2xl">
          Explore classic films and cinematic masterpieces from every era
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="-director">Director Z-A</option>
...
// Pagination Component (reuse from BooksList)
